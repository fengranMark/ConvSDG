...
if __name__ == "__main__":
    raw_input_test_file = "./2021_manual_evaluation_topics_v1.0.json"
    output_test_file = "./eval_topics.json"
    raw_qrel_file = "./trec-cast-qrels-docs.2021.qrel"
    output_qrel_file = "./qrels.tsv"
