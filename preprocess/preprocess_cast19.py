...
if __name__ == "__main__":
    ...
    cast_qrels_file = os.path.join(args.cast_dir, "train_qrels.txt")

    # OUTPUT
    out_topics_file = os.path.join(args.out_data_dir, "train_topics.jsonl")
    ...
    out_qrels_file = os.path.join(args.out_data_dir, "train_qrels.tsv")
    ...
    car_id_to_idx = pload("../cast20/car_id_to_idx.pickle")
