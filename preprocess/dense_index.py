...
from splade.libs import StreamIndexDataset, CollateClass

def dense_indexing(args):
    tokenizer, model = load_model(args.model_type, args.pretrained_doc_encoder_path)
...
def get_args():
    ...
    parser.add_argument("--model_type", type=str, default="ANCE_Passage")
    parser.add_argument("--collection_path", type=str, default="./datasets/cast21/cast21_collection.tsv", help="Path of the collection.")
    parser.add_argument("--pretrained_doc_encoder_path", type=str, default="./checkpoints/ad-hoc-ance-msmarco", help="Path of the pretrained doc encoder.")
    
    parser.add_argument("--output_index_dir_path", type=str, default="./datasets/cast21/embedings" ,help="Dir path of the output index.")
    ...
    parser.add_argument("--per_gpu_index_batch_size", type=int, default=250, help="Per gpu batch size")
