...
def get_args():
    ...
    parser.add_argument("--test_file_path", type=str, default="datasets/cast23/QR/test5.4.1_Implicit_ptkb_allresponse_5shot.jsonl")
    ...
    parser.add_argument("--output_trec_file", type=str, default="GPT3.5_test5.4.1_Implicit_ptkb_allresponse_5shot_answer.trec")
    parser.add_argument("--trec_gold_qrel_file_path", type=str, default="datasets/cast23/pruned_qrels.trec")
...
if __name__ == '__main__':
    main()
    #print_trec_res("output/cast23/dense/LLMConvGQR_cast23_res.trec", "datasets/cast23/pruned_qrels.trec", rel_threshold=1)
