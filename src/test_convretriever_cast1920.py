...
from data import padding_seq_to_same_length, Retrieval_topiocqa, Test_Retrieval_topiocqa, Test_Retrieval_cast
import os
from os import path
...
def get_test_query_embedding(args):
    ...
    test_dataset = Test_Retrieval_cast(args, tokenizer, args.test_file_path)
...
def get_args():
    ...
    #parser.add_argument("--test_file_path", type=str, default="../../ConvDR-main/datasets/cast19/eval_topics.jsonl")
    parser.add_argument("--test_file_path", type=str, default="../datasets/19_chatgpt_rewrite.jsonl")
    parser.add_argument("--passage_embeddings_dir_path", type=str, default="../../ConvDR-main/datasets/cast20/embeds")
    parser.add_argument("--passage_offset2pid_path", type=str, default="../../ConvDR-main/datasets/cast20/tokenized/offset2pid.pickle")
    #parser.add_argument("--pretrained_encoder_path", type=str, default="../output/cast/model/convq-best-retriever-Falsehard-topic-combine")
    ...
    parser.add_argument("--output_trec_file", type=str, default="convq_cast19_chatgpt_rewrite_res.trec")
    parser.add_argument("--trec_gold_qrel_file_path", type=str, default="../../ConvDR-main/datasets/cast19/qrels.tsv")
    ...
    parser.add_argument("--passage_block_num", type=int, default=16) # 22 for qrecc and 26 for topiocqa
...
if __name__ == '__main__':
    main()
    #print_trec_res("../output/cast/file/ancepos_convq_prompt_cast19_res.trec", "../../ConvDR-main/datasets/cast19/qrels.tsv", rel_threshold=1)
