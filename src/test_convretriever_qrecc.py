...
from data import padding_seq_to_same_length, Retrieval_topiocqa, Test_Retrieval_qrecc
import os
from os import path
...
def get_test_query_embedding(args):
    ...
    test_dataset = Test_Retrieval_qrecc(args, tokenizer, args.test_file_path)
...
def get_args():
    ...
    parser.add_argument("--test_file_path", type=str, default="../../ConvDR-main/datasets/qrecc/new_preprocessed/test.json")
    #parser.add_argument("--test_file_path", type=str, default="../datasets/topiocqa/test_with_gold_rel.json")
    ...
    parser.add_argument("--pretrained_encoder_path", type=str, default="../output/qrecc/model/convqa-best-retriever-bm25")
    parser.add_argument("--qrel_output_path", type=str, default="../output/qrecc/file")
    parser.add_argument("--output_trec_file", type=str, default="bm25pos_convqa_prompt_res.trec")
    parser.add_argument("--trec_gold_qrel_file_path", type=str, default="../../ConvDR-main/datasets/qrecc/new_preprocessed/qrecc_qrel.tsv")
    ...
    parser.add_argument("--per_gpu_test_batch_size", type=int, default=2)
    parser.add_argument("--passage_block_num", type=int, default=22) # 22 for qrecc and 26 for topiocqa
...
if __name__ == '__main__':
    #main()
    print_trec_res("../output/qrecc/file/bm25pos_convqa_prompt_res.trec", "../../ConvDR-main/datasets/qrecc/new_preprocessed/qrecc_qrel.tsv", rel_threshold=1)
