...
from data import Retrieval_cast_augment, Retrieval_cast_topic


def save_model(args, model, tokenizer, step):
    output_dir = oj(args.model_output_path, '{}-best-retriever-{}hard-topic-combine'.format(args.mode, str(args.is_hard_neg)))
...
def train(args):
    ...
    # data prepare
    train_dataset = Retrieval_cast_augment(args, tokenizer, args.train_file_path)
...
def get_args():
    ...
    parser.add_argument("--train_file_path", type=str, default="../datasets/q+a+topic_cast1920_dev_with_relp_new.jsonl")
    parser.add_argument('--model_output_path', type=str, default="../output/cast/model")
    parser.add_argument("--extend_train_file_path", type=str, default="../datasets/q+a+topic_cast19_topic_with_relp.jsonl")
