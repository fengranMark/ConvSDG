...
from data import padding_seq_to_same_length, Retrieval_topiocqa, Test_Retrieval_topiocqa
import os
from os import path
...
def get_test_query_embedding(args):
    ...
    test_dataset = Test_Retrieval_topiocqa(args, tokenizer, args.test_file_path)
...
def get_args():
    ...
    parser.add_argument("--test_file_path", type=str, default="../../ConvRJ/datasets/topiocqa/test.json")
    ...
    parser.add_argument("--pretrained_encoder_path", type=str, default="../output/topiocqa/model/convqp-best-retriever-bm25-conv+topic")
    parser.add_argument("--qrel_output_path", type=str, default="../output/topiocqa/file")
    parser.add_argument("--output_trec_file", type=str, default="convqbm25pos_convqp_prompt_res.trec")
    parser.add_argument("--trec_gold_qrel_file_path", type=str, default="../../ConvRJ/datasets/topiocqa/topiocqa_qrel.trec")
...
if __name__ == '__main__':
    main()
    #print_trec_res("../output/topiocqa/file/bm25pos_convqp_prompt_realextend_res.trec", "../../ConvRJ/datasets/topiocqa/topiocqa_qrel.trec", rel_threshold=1)
