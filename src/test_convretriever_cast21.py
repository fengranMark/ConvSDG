...
from data import padding_seq_to_same_length, Retrieval_topiocqa, Test_Retrieval_topiocqa, Test_Retrieval_cast21
import os
from os import path
...
def get_test_query_embedding(args):
    ...
    test_dataset = Test_Retrieval_cast21(args, tokenizer, args.test_file_path)
...
def output_test_res(query_embedding2id,
    ...
    trec_res = print_trec_res(output_trec_file + ".agg", args.trec_gold_qrel_file_path, args.rel_threshold)
    return trec_res
...
def get_args():
    ...
    parser.add_argument("--test_file_path", type=str, default="../../ConvDR-main/datasets/cast21/eval_topics.json")
    #parser.add_argument("--test_file_path", type=str, default="../datasets/21_chatgpt_rewrite.jsonl")
    parser.add_argument("--passage_embeddings_dir_path", type=str, default="../../ConvDR-main/datasets/cast21/embeds")
    #parser.add_argument("--passage_offset2pid_path", type=str, default="../../ConvDR-main/datasets/cast20/tokenized/offset2pid.pickle")
    parser.add_argument("--pretrained_encoder_path", type=str, default="../output/cast/model/cast21-convq-best-retriever-ance-combine")
    #parser.add_argument("--pretrained_encoder_path", type=str, default="../../ConvDR-main/checkpoints/ad-hoc-ance-msmarco")
    #parser.add_argument("--pretrained_encoder_path", type=str, default="../../ConvDR-main/output/train_qrecc/Checkpoint/Convdr-best-model")
    parser.add_argument("--qrel_output_path", type=str, default="../output/cast/file")
    parser.add_argument("--output_trec_file", type=str, default="convq_cast21_combine_res.trec")
    parser.add_argument("--trec_gold_qrel_file_path", type=str, default="../../ConvDR-main/datasets/cast21/trec-cast-qrels-docs.2021.qrel")

    parser.add_argument("--test_type", type=str, default="convq")
    parser.add_argument("--is_train", type=bool, default=False)
    parser.add_argument("--top_k", type=int, default=100)
    parser.add_argument("--n_gpu", type=int, default=1)
    parser.add_argument("--rel_threshold", type=int, default=2)
    parser.add_argument("--seed", type=int, default=42)
    parser.add_argument("--per_gpu_test_batch_size", type=int, default=4)
    parser.add_argument("--passage_block_num", type=int, default=17) # 22 for qrecc and 26 for topiocqa
...
if __name__ == '__main__':
    main()
    #print_trec_res("../output/cast/file/bm25pos_convq_cast21topic_res.trec" + ".agg", "../../ConvDR-main/datasets/cast21/trec-cast-qrels-docs.2021.qrel", rel_threshold=2)
